...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800"></h1>
                <!-- begin add div -->
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newEkobimaModal"><i class="fa fa-plus-circle" style="font-size:24px"></i></a>
                <!-- end add div -->
...
<!-- End of Main Content --  >       
 ...
 <!-- Modal -->
 <div class="modal fade" id="newEkobimaModal" tabindex="-1" role="dialog" aria-labelledby="newEkobimaModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEkobimaModal">Add New Data</h5>
            ...
            <form action="<?= base_url('menu'); ?>" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus-circle" style="font-size:18px"></i></button>
                </div>
            </form>
        </div>
    </div>
